...
books_dict["Python Fumdamnetals"] = "John Smith"
...
search_title = input("Enter the tiltle of the book to search: ")
if search_title in books_list:
    print(f"Books found! The Author of the book {search_title} is {books_dict
    [search_title]}")
else:
    print("Books not found")

remove_title = input("Enter the ttitle of the book to remove 0r else enter to skip: ")
